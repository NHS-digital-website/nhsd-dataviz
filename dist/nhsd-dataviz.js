var nhsdviz = (function (exports) {
  ...
  */
  ...
  function optionDefaults (options) {
      ...
      var fullOptions = _assign(_assign({}, options), { visualisationId: visualisationId, vizType: vizType });
      return fullOptions;
  }
